...
2. [4G/3G/2G/GSM/GPRS/GNSS HAT](Images/Raspberry_PI_LTE.png) om tijdelijk over te schakelen naar mobiel data GSM netwerk indien internet via vast ethernet weggevallen is. Als alternatief kan de beschikbare [Huawei E8372h-153 - 4G Dongle](Images/Huawei E8372h-153-4G_Dongle.png) gebruikt worden. 
## Software
...
![Huawei - 4G Dongle](Images/Huawei E8372h-153-4G_Dongle.png)
