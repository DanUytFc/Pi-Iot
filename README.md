...
1. Slimme thermostaat Vaillant vSmart: uitzetten manuele mode iedere avond om 22:00. Raadpleeg het [Python script](Sources/vSmart_Manual_Disable.py) en [log file](Logs/vSmart_manual_ligfile.txt) voor meer details. 
