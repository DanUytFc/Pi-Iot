...
3. Connecteer Raspberry Pi met de *Tuya Smart Life*app [Connect a Raspberry Pi to the Cloud Using Link SDK](https://developer.tuya.com/en/demo/link-sdk-demo-raspberry-pi). Tuya product *Pi-Iot BEK38*.
